...
const ReasonCard = ({ icon, title, description, delay }: ReasonCardProps) => {
  return (
    ...
    >
      <div className="absolute -top-10 -right-10 w-40 h-40 bg-gradient-to-br from-nexora-gold/20 to-nexora-purple/10 rounded-full blur-2xl"></div>
      <div className="relative z-10">
        <div className="text-nexora-purple mb-6 inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-r from-nexora-gold/20 to-nexora-purple/20">
          {icon}
        </div>
  ...
  return (
    <section id="why-choose-section" className="py-24 relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full max-w-7xl pointer-events-none">
        <div className="absolute w-full h-full border-[20px] border-nexora-gold/5 rounded-full transform rotate-45"></div>
